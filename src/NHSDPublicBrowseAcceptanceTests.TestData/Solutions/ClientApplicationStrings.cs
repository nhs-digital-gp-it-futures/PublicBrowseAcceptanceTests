    ...
    internal static class ClientApplicationStrings
    {
        ...
        internal static Dictionary<string, string> NativeMobileSections = new Dictionary<string, string>
        {
            {"Mobile first", "\"NativeMobileFirstDesign\":true,"},
            {
                ...
                "\"MobileOperatingSystems\":{\"OperatingSystems\":[\"Apple IOS\",\"Android\"],\"OperatingSystemsDescription\":\"Operating System Description\"},"
            },
            {
                "Memory and storage",
                "\"MobileMemoryAndStorage\":{\"MinimumMemoryRequirement\":\"256MB\",\"Description\":\"Additional Storage Requirements\"},"
            },
        ...
        internal static Dictionary<string, string> NativeDesktopSections = new Dictionary<string, string>
        {
            {
                "Supported operating systems",
                "\"NativeDesktopOperatingSystemsDescription\":\"Windows 7,8,10\r\nUbuntu\","
            },
